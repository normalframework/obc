...
const sampler_875b0f69 = require("../standard/Buildings/Controls/OBC/CDL/Discrete/Sampler");
const triggeredsampler_bcb3b170 = require("../standard/Buildings/Controls/OBC/CDL/Discrete/TriggeredSampler");
const unitdelay_bcd3bd80 = require("../standard/Buildings/Controls/OBC/CDL/Discrete/UnitDelay");
const edge_3f236118 = require("../standard/Buildings/Controls/OBC/CDL/Logical/Edge");
const latch_a5aa3a49 = require("../standard/Buildings/Controls/OBC/CDL/Logical/Latch");
const constant_48cc1015 = require("../standard/Buildings/Controls/OBC/CDL/Logical/Sources/Constant");
const switch_1cc03fcf = require("../standard/Buildings/Controls/OBC/CDL/Logical/Switch");
const timer_a61e7f4a = require("../standard/Buildings/Controls/OBC/CDL/Logical/Timer");
const truedelay_b49d8a1a = require("../standard/Buildings/Controls/OBC/CDL/Logical/TrueDelay");
const truehold_60ac3548 = require("../standard/Buildings/Controls/OBC/CDL/Logical/TrueHold");
const abs_a5faf0c3 = require("../standard/Buildings/Controls/OBC/CDL/Reals/Abs");
const greater_b1da53cb = require("../standard/Buildings/Controls/OBC/CDL/Reals/Greater");
const greaterthreshold_64a3c4e0 = require("../standard/Buildings/Controls/OBC/CDL/Reals/GreaterThreshold");
const min_a5fb1ea3 = require("../standard/Buildings/Controls/OBC/CDL/Reals/Min");
const multiplybyparameter_13a4f29f = require("../standard/Buildings/Controls/OBC/CDL/Reals/MultiplyByParameter");
const constant_baefa089 = require("../standard/Buildings/Controls/OBC/CDL/Reals/Sources/Constant");
const subtract_029d2d63 = require("../standard/Buildings/Controls/OBC/CDL/Reals/Subtract");
const switch_6d141143 = require("../standard/Buildings/Controls/OBC/CDL/Reals/Switch");
