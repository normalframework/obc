...
module.exports = (
  ...
  const enaDis2Fn = enable_ec618957({});
  ...
  return (
    ...
    const enaDis = enaDisFn({ hCut: hOutCut.y, hOut: hOutBelowCutoff.y, TCut: TOutCut.y, TOut: TOut.y, u1SupFan: supFanSta.y, uFreProSta: freProSta.y, uOutDam_max: outDamPosMaxSig.y, uOutDam_min: outDamPosMinSig.y });
