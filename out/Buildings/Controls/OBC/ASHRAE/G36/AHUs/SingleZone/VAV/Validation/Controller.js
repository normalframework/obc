...
module.exports = (
  ...
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Validation.Controller.occSch
  const occSchFn = occupancyschedule_6b502767({ occupancy: "3600*{4,20}" });
