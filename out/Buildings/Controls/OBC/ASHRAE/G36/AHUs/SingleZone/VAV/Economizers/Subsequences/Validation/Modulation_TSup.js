...
module.exports = (
  ...
  return (
    ...
    const mod = modFn({ TSup: TSup.y, TSupHeaEcoSet: TSupSetSig.y, uOutDam_max: outDamPosMax.y, uOutDam_min: outDamPosMin.y, uRetDam_max: RetDamPosMax.y, uRetDam_min: RetDamPosMin.y });
    const fanStatus = fanStatusFn({ y: mod.u1SupFan });
