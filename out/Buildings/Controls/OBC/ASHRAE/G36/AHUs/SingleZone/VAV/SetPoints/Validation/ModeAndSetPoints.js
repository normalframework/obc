...
module.exports = (
  ...
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.Validation.ModeAndSetPoints.occSch
  ...
  const modSetPoiFn = modeandsetpoints_487fe58e({ have_locAdj: true, have_occSen: true, sepAdj: true });
  ...
  return (
    ...
    const modSetPoi = modSetPoiFn({ cooDowTim: cooDowTim.y, cooSetAdj: swi2.y, heaSetAdj: swi1.y, u1Occ: occSch.occupied, TOccCooSet: TCooSetOcc.y, TOccHeaSet: THeaSetOcc.y, TUnoCooSet: TCooSetUno.y, TUnoHeaSet: THeaSetUno.y, TZon: zonTem.y, u1OccSen: occSta.y, uCooDemLimLev: cooDemLimLev.y, uHeaDemLimLev: heaDemLimLev.y, warUpTim: warUpTim.y });
