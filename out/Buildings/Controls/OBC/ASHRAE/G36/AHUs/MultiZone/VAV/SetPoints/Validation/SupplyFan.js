...
module.exports = (
  ...
  const conSupFanFn = supplyfan_d6d95546({ controllerType: Math.PI, k: 0.001, maxSet: 400, Td: 1, Ti: 10 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.Validation.SupplyFan.conSupFan1
  const conSupFan1Fn = supplyfan_d6d95546({ controllerType: Math.PI, have_perZonRehBox: true, k: 0.001, maxSet: 400, Td: 1, Ti: 10 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.Validation.SupplyFan.conSupFan2
  const conSupFan2Fn = supplyfan_d6d95546({ controllerType: Math.PI, k: 0.001, maxSet: 400, Td: 1, Ti: 10 });
