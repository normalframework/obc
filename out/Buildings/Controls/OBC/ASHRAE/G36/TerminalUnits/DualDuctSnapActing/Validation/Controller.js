...
module.exports = (
  ...
  const VColDis_flowFn = sin_9696c4d3({ amplitude: 0.6, freqHz: "1/28800", offset: 1.2 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Validation.Controller.VHotDis_flow
  const VHotDis_flowFn = sin_9696c4d3({ amplitude: 0.6, freqHz: "1/28800", offset: 1.2 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Validation.Controller.duaDucCon
  const duaDucConFn = controller_b94b6f37({ damPosHys: 0.01, floHys: 0.01, have_duaSen: true, looHys: 0.01, staPreMul: 1, VAreBreZon_flow: 0.006, VCooMax_flow: 1.5, venStd: 0, VHeaMax_flow: 1.2, VMin_flow: 0.5, VPopBreZon_flow: 0.005 });
