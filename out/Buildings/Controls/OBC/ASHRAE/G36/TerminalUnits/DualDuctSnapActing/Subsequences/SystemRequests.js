...
module.exports = (
  ...
  const mulIntFn = multiply_2099ee67({});
  ...
  const conOneFn = constant_8c5ba27d({ k: 1 });
  ...
  const conOne1Fn = constant_8c5ba27d({ k: 1 });
  // http://example.org#Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Subsequences.SystemRequests.mulInt3
  const mulInt3Fn = multiply_2099ee67({});

  return (
    { uAftSupCoo, uAftSupHea, u1CooDam, u1HeaDam, VColDuc_flow_Set, VHotDuc_flow_Set, VColDucDis_flow, VHotDucDis_flow, uCoo, uHea, uCooDam, uHeaDam, TZon, TCooSet }
  ) => {
