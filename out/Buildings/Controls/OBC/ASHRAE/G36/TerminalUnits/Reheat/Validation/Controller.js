...
module.exports = (
  ...
  const rehBoxConFn = controller_ce4bcbac({ controllerTypeVal: Math.PI, damPosHys: 0.01, floHys: 0.01, hotWatRes: 1, looHys: 0.01, staPreMul: 1, valPosHys: 0.01, VAreBreZon_flow: 0.006, VCooMax_flow: 1.5, venStd: 0, VHeaMax_flow: 1.2, VHeaMin_flow: 0.5, VMin_flow: 0.5, VPopBreZon_flow: 0.005 });
